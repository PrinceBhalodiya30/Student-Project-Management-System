...
import { FolderKanban, Users, Calendar, CheckSquare, ArrowRight, AlertCircle } from "lucide-react"
...
export default async function StudentDashboard() {
    ...
    return (
        <div className="flex flex-col min-h-screen w-full">
            <TopBar title="Student Dashboard" user={{ name: user?.fullName, email: user?.email }} />
